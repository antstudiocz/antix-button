...
import { Button } from "../src"; // Import from local package source
import styles from "./ButtonVariantsDemo.module.css";

// Use types from the Button component
...
const ButtonVariantsDemo: React.FC = () => {
  ...
  // SVG for the smaller pencil icon
  ...
  const buttonScenarios: ButtonScenario[] = [
    ...
    {
      title: "Button-text s ikonou - pred",
  ...
  // Helper function to get the appropriate icon based on size
